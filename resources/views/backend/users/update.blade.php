                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <div class="form-check">
                                <input type="radio" class="form-check-input" id="customControlValidation1" name="gender"
                                       value="{{ \App\Models\User::GENDER_BOY }}"
                                    {{ $user -> gender == \App\Models\User::GENDER_BOY ? 'checked' : ''}}/>
                                <label class="form-check-label mb-0" for="customControlValidation1">Nam</label>
                            </div>
                            <div class="form-check">
                                <input type="radio" class="form-check-input" id="customControlValidation2" name="gender"
                                       value="{{ \App\Models\User::GENDER_GIRL }}"
                        ...
                        <div class="col-md-9">
                            <select name="phone_company" class="select2 form-select shadow-none" style="width: 100%; height: 36px">
                                ...
                                <optgroup label="Android">
                                    ...
                                    <option value="OPPO" {{$user -> phone_company == "OPPO" ? 'selected' : ''}}>Oppo</option>
